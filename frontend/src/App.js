...
class App extends React.Component {
  ...
  handleSubmit(event) {
    ...
    axios.post('http://10.0.0.142:8007/users/', { 'email': email, 'username': username, 'password': password }).then(console.log("Success"));
  }
  ...
  handleSubmitLogIn(event) {
    ...
    event.preventDefault();
    axios.get('http://10.0.0.142:8007/users/').then(responseArr => {
  ...
  getClasses() {
    axios.get('http://10.0.0.142:8007/classes/').then(responseArr => {
  ...
  //get students
  getStudents() {
    axios.get('http://10.0.0.142:8007/students/').then(responseArr => {
  ...
  handleSubmitCreateClass(event) {
    ...
    axios.post('http://10.0.0.142:8007/classes/', { "courseId": courseId, "courseName": courseName, "meetingSchedule": meetingSchedule, "username": this.state.id });
    this.setState({ addingClass: "No" });
    this.getClasses();
  }
  ...
  handleSubmitStudentClass(event) {
    ...
    axios.post('http://10.0.0.142:8007/students/', submissionData).then(alert("success!"));
